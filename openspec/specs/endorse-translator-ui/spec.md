# endorse-translator-ui Specification

## Purpose
The Endorsement Translator UI provides an interactive, responsive web portal for insurance teams, evaluators, and client applications to configure, authenticate, transmit, and inspect policy endorsement translations into the core platform format.
## Requirements
